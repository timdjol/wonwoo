...
class Basket
{
    ...
    public function saveOrder($name, $phone, $email, $type_address, $address, $comment, $type_payment){
        if(!$this->countAvailable(true)){
            return false;
        }
        $this->order->saveOrder($name, $phone, $type_address, $address, $comment, $type_payment);
